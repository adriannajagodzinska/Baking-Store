...
{
    public class PrzepisyInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<PrzepisyContext>
    {
        protected override void Seed(PrzepisyContext context)
        {
            ...
            recipes.ForEach(x => context.Recipes.Add(x));
            context.SaveChanges();
            ...
            measurements.ForEach(x => context.Measurements.Add(x));
            context.SaveChanges();
           ...
           new Ingredient{IngredientID=19, IngredientName="żółtko", CaloriesQuantity=70},
            ...
            quantities.ForEach(x => context.Quantities.Add(x));
            context.SaveChanges();
        }
    }
}